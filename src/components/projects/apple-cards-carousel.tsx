          ...
          >
            {items.map((item, index) => (
              <motion.div
                ...
                key={'card' + index}
                className="rounded-3xl pr-4 shrink-0"
              >
                {item}
              </motion.div>
            ))}
        ...
        {open && (
          <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto py-10 px-4">
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 h-full w-full bg-[#1D1D1F]/70 backdrop-blur-lg"
            />
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              ...
              className="relative z-[60] mx-auto my-10 h-fit max-w-5xl rounded-3xl bg-[#F5F5F7] dark:bg-[#1D1D1F] font-sans"
            >
              {/* Sticky close button */}
